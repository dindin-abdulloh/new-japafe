...
import AksiFormatter from '../components/master_material/AksiFormatter'
...
import ModalTambah from '../components/master_material/ModalTambah'
import ModalEdit from '../components/master_material/ModalEdit'
import ModalDetail from '../components/master_material/ModalDetail'
import ModalRemove from '../components/master_material/ModalRemove'
...
const MasterMaterial = () => {
    console.log('====================================')
    console.log('page master_material')
    console.log('====================================')
...
export default memo(MasterMaterial)
