...
import AksiFormatter from '../components/purchase_receive/AksiFormatter'
...
import ModalTambah from '../components/purchase_receive/ModalTambah'
import ModalEdit from '../components/purchase_receive/ModalEdit'
import ModalDetail from '../components/purchase_receive/ModalDetail'
import ModalRemove from '../components/purchase_receive/ModalRemove'
...
const PurchaseReceive = () => {
    console.log('====================================')
    console.log('page purchase_receive')
    console.log('====================================')
...
export default memo(PurchaseReceive)
