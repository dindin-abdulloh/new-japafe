...
import AksiFormatter from '../components/service_order/AksiFormatter'
...
import ModalTambah from '../components/service_order/ModalTambah'
import ModalEdit from '../components/service_order/ModalEdit'
import ModalDetail from '../components/service_order/ModalDetail'
import ModalRemove from '../components/service_order/ModalRemove'
...
const ServiceOrder = () => {
    console.log('====================================')
    console.log('page service_order')
    console.log('====================================')
