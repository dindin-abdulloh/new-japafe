...
import AksiFormatter from '../components/purchase_order/AksiFormatter'
...
import ModalTambah from '../components/purchase_order/ModalTambah'
import ModalEdit from '../components/purchase_order/ModalEdit'
import ModalDetail from '../components/purchase_order/ModalDetail'
import ModalRemove from '../components/purchase_order/ModalRemove'
...
const PurchaseOrder = () => {
    console.log('====================================')
    console.log('page purchase_order')
    console.log('====================================')
