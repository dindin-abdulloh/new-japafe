...
import AksiFormatter from "../components/service_receive/AksiFormatter";
...
import ModalTambah from "../components/summary_report/ModalTambah";
import ModalEdit from "../components/service_receive/ModalEdit";
import ModalDetail from "../components/service_receive/ModalDetail";
import ModalRemove from "../components/service_receive/ModalRemove";
...
const ServiceReceive = () => {
  console.log("====================================");
  console.log("page service_receive");
  console.log("====================================");
