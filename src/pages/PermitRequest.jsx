...
import AksiFormatter from '../components/permit_request/AksiFormatter'
...
import ModalTambah from '../components/permit_request/ModalTambah'
import ModalEdit from '../components/permit_request/ModalEdit'
import ModalDetail from '../components/permit_request/ModalDetail'
import ModalRemove from '../components/permit_request/ModalRemove'
...
const PermitRequest = () => {
    console.log('====================================')
    console.log('page permit_request')
    console.log('====================================')
...
export default memo(PermitRequest)
